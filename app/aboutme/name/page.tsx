  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-lg font-bold mb-4 mt-2">$ cat about_name.txt</h1>
        <pre className="whitespace-pre-wrap">
{`ชื่อของผม "สิทธินนท์ สุดแก้ว" ได้รับจากคุณพ่อคุณแม่ตั้งให้ตั้งแต่เกิดมีความหมายที่สื่อถึงความรู้และความเฉลียวฉลาด ส่วนชื่อในเกมจะใช้ sutkaew กับ waektus โดย waektus นั้นแค่เอา sutkeaw มาสลับตัวอักษรและสลับ a กับ e `}
        </pre>
        <p className="mt-4">$</p>
      </motion.div>
    </motion.div>
