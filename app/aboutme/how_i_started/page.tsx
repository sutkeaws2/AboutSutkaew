  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-lg font-bold mb-4 mt-2">$ cat how_i_started.txt</h1>
        <pre className="whitespace-pre-wrap">
{`ผมเริ่มต้นการพัฒนาโปรแกรมจากการเรียนรู้ภาษา Python ในช่วงมัธยมต้น ซึ่งเป็นจุดเริ่มต้นที่ทำให้ผมหลงรักการเขียนโค้ด หลังจากนั้นผมได้ทดลองใช้ภาษาอื่นๆ เช่น JavaScript และ C# ส่วนใหญ่ผมศึกษาด้วยตัวเองผ่านทางออนไลน์และทำโปรเจกต์เล็กๆ`}
        </pre>
        <p className="mt-4">$</p>
      </motion.div>
    </motion.div>
